...
public class RedisService {
    ...
    public void produce(Object json) {
        redisTemplate.opsForList().leftPush(prefix + MESSAGE_KEY, new Gson().toJson(json));
    }
    ...
    public String getString(String key) {
        return key == null ? null : stringRedisTemplate.opsForValue().get(prefix + key);
    }
